...
public class HierarchicalTreeController {
  ...
  public AggregatedDependencies outgoingDependencies(@PathParam("id") String fromIds, @PathParam("to") String toIds) {
    ...
    //
    return getAggregatedDependencies(fromIds, toIds,
        (sourceNode, targetNodes) -> sourceNode.getOutgoingDependenciesTo(targetNodes));
  }
...
//  }
  ...
  public AggregatedDependencies incomingDependencies(@PathParam("id") String nodeIds,
    ...
    //
    return getAggregatedDependencies(nodeIds, fromIds,
        (sourceNode, targetNodes) -> sourceNode.getIncomingDependenciesFrom(targetNodes));
  }
   ...
   * @return
   */
  private AggregatedDependencies getAggregatedDependencies(String sourceIds, String targetIds,
      BiFunction<HGNode, List<HGNode>, List<HGAggregatedDependency>> dependencyResolver) {
