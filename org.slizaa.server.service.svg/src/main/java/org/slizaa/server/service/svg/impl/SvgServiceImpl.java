...
public class SvgServiceImpl implements ISvgService {
            ...
            if (map != null && !map.isEmpty()) {
                for (String key : map.keySet()) {
                    ...
                    if (decodedKey.isOverlayImage) {
                        createSvgAndReturnShortKey(decodedKey.main, decodedKey.upperLeft, decodedKey.upperRight, decodedKey.lowerLeft, decodedKey.lowerRight);
                    } else {
    ...
    @Override
    public String createSvgAndReturnShortKey(String main, String upperLeft, String upperRight, String lowerLeft, String lowerRight) {
        checkNotNull(main);
    ...
    private String getOrCreateShortKey(boolean isOverlayImage, String main, String upperLeft, String upperRight, String lowerLeft,
                                       String lowerRight) {
