...
public class GraphDatabaseStateMachine
    ...
    @Override
    public void configure(StateMachineStateConfigurer<GraphDatabaseState, GraphDatabaseTrigger> states)
            throws Exception {

        states
                // @formatter:off
                .withStates()
                .initial(GraphDatabaseState.INITIAL)
                .choice(GraphDatabaseState.PARSING)
